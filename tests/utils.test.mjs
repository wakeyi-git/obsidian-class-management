...
test("표 셀 <br> 표기를 줄바꿈으로 되돌린다", async () => {
  const { tableCellDisplayText } = await loadTypeScriptModule("../packages/core/src/utils.ts");
  assert.equal(tableCellDisplayText("154~155쪽<br>#정보통신윤리교육"), "154~155쪽\n#정보통신윤리교육");
  assert.equal(tableCellDisplayText("한 줄<BR/><br />두 줄"), "한 줄\n두 줄");
  assert.equal(tableCellDisplayText("그대로"), "그대로");
});
