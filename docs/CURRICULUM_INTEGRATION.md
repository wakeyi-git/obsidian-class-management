...
`교육과정/단원/`의 각 Markdown 노트는 다음 항목을 가집니다.
...
수업일지는 상위 단원의 스트랜드와 주된 탐구 단계를 참조합니다. 일반화 단계 완료 시에는 학생이 실제로 형성한 일반화를, 전이 단계 완료 시에는 새로운 상황에 적용한 증거를 기록해야 합니다. 교사가 계획한 일반화 문장을 학생의 성취로 자동 복사하지 않습니다.
